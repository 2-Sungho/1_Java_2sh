		...
		do {
	        ...
	        try {
	        	...
	        	case 4: removeStudent();
	        		break;
	        	case 5: selectStudent1();
	        		break;
	        	case 6: selectStudent2();
	        		break;
...
//		}
		...
		// for(요소하나를 꺼내서 참조할 변수:배열 또는 컬렉션)
	...
	public void updateStudent() {
		...
		// 인덱스가 일치하지 않는 학생이 없다면 실패(인덱스 불일치) 출력
	...
	public void selectStudent1() {
		...
		List<Student> resultList=service.selcectStudent1(name);
	...
	public void selectStudent2() {
		...
		List<Student> resultList=service.selcectStudent2(name);
		if(resultList.isEmpty()) {
			// List.isEmpty() : 리스트에 저장된 요소가 없으면 true
			// resultList.size()=0;
			System.out.println("검색 결과가 없습니다.");
