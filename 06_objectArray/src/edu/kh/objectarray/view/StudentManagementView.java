...
import edu.kh.objectarray.model.service.StudentManagentService;
...
public class StudentManagementView {
	...
	private StudentManagentService service=new StudentManagentService();
	...
	public void displayMenu() {
		...
		do {
			...
			case 1: this.addStudent();
				break;
			case 2: this.printAll();
				break;
			case 3: this.selectIndex();
				break;
			case 4: this.selectName();
				break;
			case 5: this.updateStudent();
				break;
	...
	public void addStudent() {
		...
		// 학생 추가 서비스 메서드 호출
		int result=service.addStudent(grade, classRooom, number, name);
	...
	public void printAll() {
		...
		for(int i=0;i<stdArr.length;i++) {
			...
			System.out.printf("|   %2d |  %2d |  %2d | %3s |  %3d |  %3d |  %3d |\n",
					stdArr[i].getGrade(),stdArr[i].getClassRoom(),stdArr[i].getNumber(),stdArr[i].getName(),stdArr[i].getKor(),stdArr[i].getEng(),stdArr[i].getMath());		
		}
	}
