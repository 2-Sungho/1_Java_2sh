...
// service : 기능 제공용 클래스
public class StudentManagentService {

	// Student 참조변수 5칸짜리 객체 배열 생성
	private Student[] stdArr=new Student[5];
	
	// 기본생성자
	public StudentManagentService() {
		stdArr[0]=new Student(3, 15, 17, "홍길동", 100, 30, 70);
	...
	public int addStudent(int grade,int classRoom,int number,String name) {
		...
		// 배열 요소 중 아무것도 참조하지않는(null)인덱스 찾기
		// 단, 모든 인덱스가 참조중인 경우 0 반환
